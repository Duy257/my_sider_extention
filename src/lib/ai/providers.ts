...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { id: "opencode", label: "OpenCode", baseUrl: "https://api.opencode.ai/v1/chat/completions", defaultModel: "gpt-4o-mini", knownModels: ["gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-4", "gpt-3.5-turbo"], modelsUrl: "https://opencode.ai/zen/go/v1/models" },
